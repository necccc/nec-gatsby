...
![left](./let-it-throw.gif "Elza handling async errors properly")
...
`gist:9f2594c8a5a2c9247f5de9e3800a619a`
...
![right](./let-it-throw.gif "Elza handling async errors propery")
