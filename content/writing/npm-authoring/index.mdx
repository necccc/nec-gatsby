...
<PostImage
  image="node-modules.jpg"
  align="right"
  alt="node_modules folder vs black hole joke, a classic!"
/>
...
<Blockquote
  by="Kat Marchán"
  link="https://github.com/zkat/npx"
  linkText="npx"
>
...
![Complete order of lifecycle scripts of npm install and publish](./lifecycle.svg "full")
...
<Blockquote
  ...
  linkText="The German word for fear of increasing the major version number"
  link="https://speakerdeck.com/boennemann/we-fail-to-follow-semver-and-why-it-neednt-matter-1"
>
