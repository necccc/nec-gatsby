...
![The Helm logo](./helm-logo.svg "left")
...
<video src="./ligature.m4v" autoplay loop muted playsinline title="Short video of how the caret interacts with a ligature in the browser">
</video>
...
![examples for font-variant-ligatures, font-variant-numeric and font-variant-alternates](./css-font-examples.png "right")
...
<video src="./skew.mp4" autoplay loop muted playsinline title="Short video of how the skewed header works">
</video>


![The right-angled triangles, on the top and the bottom of the skewed rectangle](./skew-triangles.png "right")
...
![Sine, cosine and tangent basics.](./sin-cos-tan.svg "right")
