...
![left](./helm-logo.svg "The Helm logo")
...
![right](./css-font-examples.png "examples for font-variant-ligatures, font-variant-numeric and font-variant-alternates")
...
![right](./skew-triangles.png "The right-angled triangles, on the top and the bottom of the skewed rectangle")
...
![right](./sin-cos-tan.svg "Sine, cosine and tangent basics.")
